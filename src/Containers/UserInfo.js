                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 statistic">
                            ...
                            <span><a  href={ (this.state.postPopulate && this.state.postPopulate[0] )  ?`https://psychologist.herokuapp.com/detailpost?postId=${this.state.postPopulate[0]._id}`:""}>{(this.state.postPopulate && this.state.postPopulate[0]) ? this.state.postPopulate[0].title :""}</a></span>
                        </div>
